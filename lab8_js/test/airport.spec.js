...
describe('Planes Test', () => {
    ...
    it('should have military Planes with transport type', () => {
        ...
        assert.isTrue(!!transportMilitaryPlanes.find(plane => plane.hasOwnProperty()));
    });
    ...
    it('should check at least one bomber in military planes presented', () => {
        let airport = new Airport(planes);
        let bomberMilitaryPlanes = airport.getBomberMilitaryPlanes();
        assert.isTrue(bomberMilitaryPlanes.length > 0)
    })
    ...
    it('should check that experimentsl planes has classification level higher than unclassified', () => {
        ...
        assert.isTrue(!!experimentalPlanes.find(plane => plane.classificationLevel === ClassificationLevel.UNCLASSIFIED))
    });
