...
public class ThomannCartTests{

    @Test(description = "cart cost updates on item count change")
    ...
    @Test(description = "item is removed from cart on decrementing count of 1")
    ...
    @Test(description = "removing item from cart by 'x' button click")
    ...
    @Test(description = "checking upper bound of item count in cart")
    ...
    @Test(description = " checking text input unavailability in cart item count input field")
    ...
    @Test(description = " checking city name length lower bound when ordering (dt3)")
    ...
    @Test(description = " checking street length upper bound when ordering (dt3)")
